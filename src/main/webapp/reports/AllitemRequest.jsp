...
<div class="container-fluid">
	<div class="row">
	<form action="/itemRequestFilter" method="get">
 	<div class="form-inline">
		...
		<div class="col-md-2 offset-1 txt2"><b>Request History</b></div>
		<div class="col-md-3 txt2"><label>Total Requests: ${reqNum}</label></div>
	</div>
