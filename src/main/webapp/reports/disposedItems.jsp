...
<div class="container-fluid">
	<div class="row">
	<form action="/disposalFilter" method="get">
 	<div class="form-inline">
		...
		<div class="col-md-2 offset-1 txt2"><b>Disposal History</b></div>
		<div class="col-md-2 txt2"><label>Total Disposed Items: ${total}</label></div>
	</div>
	...
	<div class="panel panel-primary">
                ...
                <thead class="thead-dark">
                  <tr>
                    ...
                    <th><i class="icon_table"></i>Date of Approval</th>
                    <th><i class="icon_table"></i>Approved By</th>
                   </tr>
                </thead>
                <tbody>
                  <c:forEach items="${disposedList}" var="disposal">
						<tr>
